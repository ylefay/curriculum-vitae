...
%\resumeItemListStart
%\resumeItem{Statistics, econometrics, linear time series, functional analysis, optimization, stochastic calculus, mathematical finance}
%\resumeItemListEnd
\resumeSubheading
...
\resumeItemListStart
%\resumeItem{Contributed to a proprietary scalable and highly modular framework for backtesting cross-asset trading strategies.}
%\resumeItem{
%Researched, implemented and backtested strategies (ARPs, Vol, Momentum).}
%\resumeItem{
%Implemented data mining procedures and modern regression methods.}
%\resumeItem{Contributed to a statistics and reporting library.}
