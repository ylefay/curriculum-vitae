...
\resumeItemListStart
\resumeItem{Computational optimal transport, learning for time series, probabilistic graphical models, convex optimization, generative models, bayesian machine learning}
\resumeItemListEnd
\resumeSubheading
{ENSAE}{Palaiseau, France}{\textbf{M.Eng.} in Statistics and Financial Mathematics}{2020 - 2024}
\resumeItemListStart
\resumeItem{Pricing and hedging of derivatives, state-space models and SMC methods, algorithmic trading, extreme-value theory, advanced statistics}
